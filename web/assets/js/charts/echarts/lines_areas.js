    ...
    require(
        ...
        function (ec, limitless) {
           ...
           /* stacked_area.setOption(stacked_area_options);
            ...
            relaodDataArea(basic_area,true);
            $('#reloadDataArea').on('click',function(e){
                e.preventDefault();
                relaodDataArea(basic_area,false);
            });
            // Resize charts
            // ------------------------------
...
function relaodDataArea(basic_area,reload){
    if(reload){
        basic_area.showLoading({
            text: 'Loading data'
        });
    }
    ...
    $.ajax({
        method: 'POST',
        url: Routing.generate('dashboard_area'),
        dataType: 'json',
