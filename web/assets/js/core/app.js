...
$(function() {
    ...
    $('select.multiple_select').treeMultiselect({ enableSelectAll: true,hideSidePanel:true
    });
    $('select.multiple_select_group').removeAttr('multiple');
        $('select.multiple_select_families').treeMultiselect({ enableSelectAll: true,hideSidePanel:true});
    $('#generate_password').on('click',function(){
        $('#fos_user_registration_form_plainPassword_first,#fos_user_registration_form_plainPassword_second').val(randString()).attr('type','text');
        $('#fos_user_profile_form_plainPassword_first,#fos_user_profile_form_plainPassword_second').val(randString()).attr('type','text');
    });
